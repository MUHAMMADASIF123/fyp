  ...
  return (
    <>
        ...
        <div className="row w-100">
          <div className="col-lg-4  col-md-4 col-sm-12 ">
            ...
            <p className="text-justify text-white ms-4">
              Our has built a level of trust and confidence among its existing
              and aspiring students due to the launch of innovative but
              effective study and work plans.
            </p>
          </div>
          <div className="col-lg-4 m-0 col-md-4 col-sm-12 ">
            <div className="mt-5">
              ...
              <h6 className="align-baseline me-5 text-white">
                ...
                <a
                  href="mailto:gcswahdatroad@gmail.com"
      ...
      <div className="text-white copyright m-auto">
        <span>
          {" "}
          All &copy; Right 2023 Reserved By Government Graduate college Science
          | GCS
        </span>
      </div>
    </>
