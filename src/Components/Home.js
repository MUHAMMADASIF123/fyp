        ...
        <div className="row">
          <div className="col-md-6 col-lg-3 col-sm-6 mb-2">
            <div className="card">
              ...
              <div className="card-body">
                <h5 className="card-title text-white"> Intermediate</h5>
          ...
          <div className="col-md-6 col-lg-3 col-sm-6 mb-2">
            <div className="card">
              ...
              />
              <div className="card-body">
                <h5 className="card-title text-white">Bechelors</h5>
                <p className="card-text ">
                  {" "}
          ...
          <div className="col-md-6 col-lg-3 col-sm-6 ">
            ...
            <marquee width="100%" direction="up" scrollamount="1">
              <ul>
                ...
                <br />
                <li>
                  <a href="https://bit.ly/3SvJoyv">
                    Intermediate Merit List-2 2023
                  </a>
                </li>
                <br />
                <li>
                  <a href="https://bit.ly/3VVn9ER">
                    {" "}
