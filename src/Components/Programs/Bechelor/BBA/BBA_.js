      ...
      <div className='row'>
        <div className='col-md-6  col-sm-12 mb-2 semester  rounded bg-white '>
          ...
          <p className='paragraph'>
            This program is aimed at higher-caliber under
            graduate students who are both academically able and
            exhibit strong managerial potential. This program
            spreads over 8 semesters and covers 132 credit hours
            in 4 years. The package will consist of 42 courses
            with 2 months internship in any reputed public or
            private organization. This program will lead to MBA 2
            years program.
          </p>
        </div>
        ...
        <div className='col-md-6  col-sm-12 mb-2  rounded semester bg-white'>
          ...
          <table className='table'>
            <tbody>
              ...
              <tr>
                <td>BBA-307 </td>
                <td>Taxation Management (Basic) </td>
                <td>3</td>
              </tr>
              <tr>
                <td>BBA-308 </td>
              ...
              <tr>
                <td>BBA-310 </td>
                <td>Current Business Affairs </td>
                <td>3</td>
              </tr>
              <tr>
                <td>BBA-311 </td>
