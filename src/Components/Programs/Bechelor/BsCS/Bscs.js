...
function BSCS() {
  return (
    ...
    <p className='paragraph'>
      ...
      student, who has knowledge of PC operations, to get
      initiated into the domain of software development and
      to develop basic desktop and web based applications.
      The Course seeks to take students from basic level of
      understanding to a comfortable working level of PCs.
      This course is a good one for students graduating
      from college with career goal in the ICT/IS/IT
      related field. Additionally students with at least
      five CXC subjects including English, IT and Math or
      related subject with strong interest in the IT/IS
      fields can qualify for this course.
    </p>
        </div>
    ...
    <table className='table'>
      <tbody>
        ...
        <tr>
          <td>DC-221</td>
          <td>Comp. Organization & Assembly Language </td>
          <td>3</td>
        </tr>
        <tr>
          <td>DC-221L</td>
          <td>
            Comp. Organization & Assembly Language Lab{' '}
          </td>
          <td>1</td>
        </tr>
        <tr>
      ...
      <tbody>
        ...
        <tr>
          ...
          {/* <td>
            {' '}
            <button>
              <a href='http://pu.edu.pk/downloads/BS-4Years/bscs/Semester8/UE-472.pdf'>
                {' '}
                download
              </a>
            </button>
