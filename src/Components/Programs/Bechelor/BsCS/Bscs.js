        ...
        <div className='row'>
          <div className='col-md-6  col-sm-12 mb-2 semester  rounded bg-white '>
            ...
            <p className='paragraph'>
              ...
              initiated into the domain of software development
              and to develop basic desktop and web based
              applications. The Course seeks to take students
              from basic level of understanding to a comfortable
              working level of PCs. This course is a good one for
              students graduating from college with career goal
              in the ICT/IS/IT related field. Additionally
              students with at least five CXC subjects including
              English, IT and Math or related subject with strong
              interest in the IT/IS fields can qualify for this
              course.
            </p>
          </div>
          ...
          <div className='col-md-6  col-sm-12 mb-2  rounded semester bg-white'>
            ...
            <h4 className='paragraph rounded'>
              Available Seats{' '}
            </h4>
            <hr />
