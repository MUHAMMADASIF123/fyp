              ...
              <div className="rounded shadow p-5 mt-5 h-100 w-100 bg-white">
                  ...
                  <div className="col-6 w-25">
                    <div class="card">
                      <img
                        src="..."
                        class="card-img-top"
                        alt="Please attach your Photo here"
                      />
                    </div>
                  </div>
                ...
                <div className="row g-3">
                  <div className="col">
                    ...
                    <p className="border textleft">{form.list}</p>
                  </div>
                  <div className="col">
                    <h6 className="d-flex justify-content-start">Shift:</h6>
                    <p className="border textleft">{form.shift}</p>
                  </div>
                </div>
                <div className="row g-3">
                  <div className="col">
                    ...
                    <p className="border textleft">{form.student_name}</p>
                  </div>
                  <div className="col">
                    <h6 className="d-flex justify-content-start">
                ...
                <div className="row g-3 mt-2">
                  <div className="col">
                    ...
                    <p className="border textleft">{form.father_name}</p>
                  </div>
                  <div className="col">
                    <h6 className="d-flex justify-content-start">
                ...
                <div className="row">
                  <div className="col-md-4">
                    ...
                    <p className="border textleft">{form.cnic}</p>
                  </div>
                  <div className="col-md-4">
                    <h6 className="form-h6 d-flex justify-content-start mb-0">
                      Religion
                    </h6>
                    <p className="border textleft">{form.religion}</p>
                  </div>
                  <div className="col-md-4">
                    <h6 className="form-h6 d-flex justify-content-start mb-0">
                      Domicile
                    </h6>
                    <p className="border textleft">{form.domicile}</p>
                  </div>
                </div>
                ...
                <div className="row g-3">
                  ...
                  <div className="col-md-6">
                    ...
                    <p className="border textleft">{form.email}</p>
                  </div>
                  <div className="row">
                    <div className="col-md-6">
                      <h6 className="form-h6 d-flex justify-content-start">
                    ...
                    <div className="col-md-6">
                      ...
                      <p className="border textLeft">{form.father_cnic}</p>
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-md-4">
                      ...
                      <p className="border textleft">{form.guardian_name}</p>
                    </div>
                  ...
                  <div className="col-12">
                    ...
                    <p className="border textleft">{form.current_address}</p>
                  </div>
                  <div className="col-12">
                    <h6 className="d-flex justify-content-start form-h6">
                      Address 2
                    </h6>
                    <p className="border textleft">{form.permanent_address}</p>
                  </div>
                  <div className="col-md-6">
                    <h6 className=" d-flex justify-content-start form-h6">
                      City
                    </h6>
                    <p className="border textleft">{form.city}</p>
                  </div>
                  <div className="col-md-4">
                    <h6 className=" d-flex justify-content-start form-h6">
                      State
                    </h6>
                    <p className="border textleft">{form.state}</p>
                  </div>
                  <div className="col-md-2">
                    <h6 className="form-h6 d-flex justify-content-start ">
                      Zip
                    </h6>
                    <p className="border textleft">{form.zip_code}</p>
                  </div>
                  <div className="container mt-5 ml-75">
                    <table className="table border">
                      <thead>
                        <tr>
                          <th scope="col" className="border textcenter">
                            Examination
                          </th>
                          <th scope="col" className="border textcenter">
                            Year
                ...
                {/* <button className="mt-4 me-5 font-weight-bold text-uppercase text-white text-bold shadow w-25 border-0 rounded-pill">
                  Update
                </button> */}
                {/* <button    className='mt-4 ms-5 font-weight-bold text-uppercase text-white text-bold shadow w-25 border-0 rounded-pill'>
                Delete 
              </button> */}

                {/* <button>
                  <Link to={`/StudentEdit/${form._id}`}>Edit Form </Link>
                </button> */}
              </div>
            </div>
          </div>
